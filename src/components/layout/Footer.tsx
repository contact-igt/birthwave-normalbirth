...
const quickLinks = [
  ...
  { label: "Birth Journey", href: "#journey" },
        ...
        <div className="flex flex-col gap-12 xl:flex-row xl:justify-between">
          <div className="max-w-sm">
            ...
            <p className="mt-5 sm:mt-6 text-[14.5px] sm:text-[15px] leading-relaxed text-footer-secondary">
              Doctor-led normal birth preparation and delivery care with Dr. Santoshi Nandigam at The Birth Wave, Nungambakkam, Chennai.
            </p>
          </div>
