...
export const services: readonly ServiceContent[] = [
  ...
  },
  {
    ...
    hero: {
      ...
      heading: "Preparing for a Normal Vaginal Delivery",
      intro:
    ...
    explanation: {
      heading: "What is a normal vaginal delivery?",
      body: "A normal vaginal delivery means giving birth to your baby through the vagina rather than through a Caesarean section. Labour usually involves contractions, gradual opening of the cervix and the baby’s movement through the birth canal.",
      points: [
        "Antenatal Care — Regular pregnancy check-ups help monitor the health and progress of both mother and baby.",
        "Birth Preparation — Understand labour, contractions, when to come to the hospital and what you may experience during different stages of labour.",
        "Movement & Exercise — Where medically appropriate, movement, pregnancy yoga and suitable exercises may form part of your preparation.",
        "Nutrition & Education — Receive guidance on nutrition, breathing, comfort measures, pain-relief choices and partner support.",
      ],
    },
    whoItsFor: [
      "You are pregnant and preparing for a vaginal delivery",
      "You want to understand the stages of labour and what to expect",
      "You want your birth partner involved in preparation",
      "You want an honest, clinically grounded conversation about all birth pathways",
    ],
    doctorTrust: {
      heading: "Meet Dr. Santoshi Nandigam",
      body: "Discuss your pregnancy, birth preferences and questions directly with your obstetric care team. Every pregnancy is assessed individually, and recommendations may change as pregnancy and labour progress.",
      bullets: [
        "Clear communication and individualized monitoring",
        "Open discussions about your birth preferences",
        "Connected care across pregnancy, birth, and recovery",
      ],
    },
    journey: {
      eyebrow: "DURING LABOUR",
      heading: "What Happens During Labour?",
      intro: "No two labours follow exactly the same pattern. Your maternity team will monitor how you and your baby are doing and guide you as labour progresses.",
      steps: [
        { title: "Early Labour", body: "Contractions begin and the cervix gradually starts to change." },
        { title: "Established Labour", body: "Contractions generally become stronger and more regular as the cervix continues to open." },
        { title: "Birth", body: "As labour progresses and the cervix becomes fully dilated, you are guided through the birth of your baby." },
        { title: "After Birth", body: "The immediate post-birth period includes care for you and your newborn, along with support for feeding and early recovery." },
      ],
    },
    faqs: [
      {
    ...
    cta: {
      heading: "Thinking About a Normal Vaginal Delivery?",
      body: "Start the conversation during pregnancy. Meet the BirthWave team to discuss your pregnancy, birth preparation and preferences.",
    },
  },
  {
    slug: "vbac",
